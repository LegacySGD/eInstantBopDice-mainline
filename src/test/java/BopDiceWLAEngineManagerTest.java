...
public class BopDiceWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BopDiceWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BopDiceIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BopDiceIW/InitOutcome.xml").getDocumentElement();
